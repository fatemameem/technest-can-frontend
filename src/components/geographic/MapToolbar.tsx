...
export default function MapToolbar({
  ...
  return (
    <div className="absolute top-4 left-4 bg-white rounded-md shadow-md flex p-1 z-20">
      <button 
      ...
      {showFilterIcon && (
        ...
        >
          <Image src="/category-filter.svg" alt="Filter" width={24} height={24} />
          
          {categoryFiltersCount > 0 && (
            <div className="absolute -top-2 -right-2 bg-green-500 text-white rounded-full h-5 w-5 flex items-center justify-center text-xs font-bold">
              {categoryFiltersCount}
            </div>
          )}
        </button>
